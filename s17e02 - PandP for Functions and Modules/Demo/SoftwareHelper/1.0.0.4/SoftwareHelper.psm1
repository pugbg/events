    ...
    Process
    {
		...
		try
		{
			...
			if ($PSBoundParameters.ContainsKey('ComputerName'))
			{
				...
				{
					Get-WinEvent -FilterHashtable @{Logname='Security';Id=4688} -ComputerName $ComputerName -StartTime $StartTime
				}
				else
				{
					Get-WinEvent -FilterHashtable @{Logname='Security';Id=4688} -ComputerName $ComputerName
				}
			}
			else
			{
